...
public class Application {
	...
	public static void main(String[] args) {
		 ...
		 * */
		GearStatus gearStatus = GearStatus.PARKING;
		/* 카레이서가 한 명 등장합니다. */
		CarRacer racer = new CarRacer();
		
		/* 입력받은 메뉴에 따라 카레이서의 행동이 달라집니다. */
		...
		while(true) {
			...
			System.out.println("5. 기어 변경");
			System.out.println("6. 후진");
			...
			switch(no) {
				...
				case 5 :
					System.out.println("바꾸고 싶은 기어를 선택하세요.");
					System.out.println("1. P : PARKING");
					System.out.println("2. R : REVERSE");
					System.out.println("3. N : NEUTRAL");
					System.out.println("4. D : DRIVE");
					int num = sc.nextInt();
					if(num == 1){
						gearStatus = GearStatus.PARKING;
					}else if(num == 2){
						gearStatus = GearStatus.REVERSE;
					}else if(num ==3){
						gearStatus = GearStatus.NEUTRAL;
					} else if (num == 4) {
						gearStatus = GearStatus.DRIVE;
					}
					racer.switchGear(gearStatus);
					break;
				case 6 : racer.moveBack(); break;
