...
select EMP_ID,EMP_NAME, SALARY, DEPT_CODE, JOB_CODE from EMPLOYEE where SALARY between 3500000 and 5500000;
...
select EMP_ID, EMP_NAME, PHONE from EMPLOYEE where PHONE like '01_9%';
-- 11. EMPLOYEE테이블에서 전화번호 국번이 4자리 이면서 9로 시작하는 직원의 사번, 이름, 전화번호를 조회하세요
select EMP_ID, EMP_NAME, PHONE from EMPLOYEE where PHONE like '01_9_______';
...
select EMP_NAME, SALARY, JOB_CODE from EMPLOYEE where (JOB_CODE = 'J7' or JOB_CODE = 'J2') and SALARY >= 2000000;